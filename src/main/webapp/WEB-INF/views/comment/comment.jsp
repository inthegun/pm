        ...
        <div>
            ...
            <div>
                <table class="table">                    
                    <tr>
                        <td>
                            <textarea style="width: 1100px" rows="3" cols="30" id="comment" name="comment_contact" placeholder="댓글을 입력하세요"></textarea>
                            <br>
                            <div>
                                <a href='#' onClick="fn_comment('${view.post_no }')" class="btn pull-right btn-success">등록</a>
                            </div>
                        </td>
                    </tr>
                </table>
        ...
        success : function(data){
            ...
            if(data.length > 0){
                ...
                for(i=0; i<data.length; i++){
                    ...
                    html += data[i].comment_contact + "<tr><td></td></tr>";
                    html += "</table></div>";
                    html += "</div>";
                }
